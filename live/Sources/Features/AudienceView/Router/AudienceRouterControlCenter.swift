...
class AudienceRouterControlCenter {
    ...
    init(rootViewController: UIViewController, routerManager: AudienceRouterManager, manager: AudienceStore? = nil) {
        self.rootViewController = rootViewController
        self.routerManager = routerManager
        self.manager = manager
    }
    
    func handleScrollToNewRoom(manager: AudienceStore) {
        self.manager = manager
