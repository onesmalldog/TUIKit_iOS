...
NSString *replayKitLocalizeFromTableAndCommon(NSString *key, NSString *common,
                                              NSString *table) {
...
NSString *replayKitLocalizeReplace(NSString *origin, NSString *xxx_replace,
...
NSString *replayKitLocalizeReplaceFiveCharacter(
    NSString *origin, NSString *xxx_replace, NSString *yyy_replace,
