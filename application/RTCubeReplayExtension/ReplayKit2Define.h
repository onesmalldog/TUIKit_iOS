...
#define kDarvinNotificaiotnNameRotationChange                                  \
  CFSTR("Darwin_ReplayKit2_Rotate_Change")
...
#define kDarvinNotificaiotnNameResolutionChange                                \
  CFSTR("Darwin_ReplayKit2_Resolution_Change")
